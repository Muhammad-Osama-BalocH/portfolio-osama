...
const Portfolio = () => {
  const projects = [
    ...
    {
        title: 'Project 3',
        description: 'I developed the Figna project using Next.js, creating a responsive, high-performance web application with fast rendering and built-in SEO optimization features.',
